    ...
    const [faqItems] = useState<FAQItem[]>([
        {
            ...
            answer: "The futuristic design is a modern and innovative approach that incorporates sleek and minimalist elements, bold typography, vibrant colors, and geometric shapes.",
        },
        {
            id: 2,
            question: "How can I create a futuristic design?",
            answer: "To create a futuristic design, you can use clean and minimalistic layouts, bold and futuristic fonts, vibrant color schemes, and incorporate geometric shapes and patterns.",
        },
        {
            id: 3,
            question: "How can I create a futuristic design?",
