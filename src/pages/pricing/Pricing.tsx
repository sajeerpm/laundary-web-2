      ...
      <div className="mx-auto w-5/6 py-8">
        <div className="grid w-full grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-4">
          ...
          <button
            ...
            onClick={() => handleTabClick(2, "Mixed wash (Per load)")}
          >
            Mixed wash (Per load)
          </button>
          <button
          ...
          <button
            ...
            onClick={() => handleTabClick(4, "Repairs & Alterations")}
          >
            Repairs & Alterations
          </button>
        </div>
        ...
        <ul className="justify-center gap-16 whitespace-nowrap py-8 md:flex">
          <li className="flex flex-col items-center justify-center">
            ...
            <div className="">
              ...
              <p className="py-2 text-center">Washed and Pressed</p>
          ...
          <li className="flex flex-col items-center justify-center">
            ...
            <div className="">
              <p className="py-2 text-center uppercase">Day Dress</p>
          ...
          <li className="flex flex-col items-center justify-center">
            ...
            <div className="">
              <p className="py-2 text-center uppercase">Service Wash</p>
              <p className="py-2 text-center">Wash, Dry and Fold</p>
          ...
          <li className="flex flex-col items-center justify-center">
            ...
            <div className="">
              <p className="py-2 text-center uppercase">Bedding</p>
              <p className="py-2 text-center">Bed Set (Wash and Press)</p>
              <p className="py-2 text-center font-extrabold">From £14.00</p>
            </div>
          </li>
        </ul>
      </div>
